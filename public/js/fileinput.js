...
(function (factory) {
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                var node = ctr + i, previewId = previewInitId + "-" + node, file = files[i], fSizeKB, j, msg,
                    ...
                    caption = file.name ? self.slug(file.name) : '', fileSize = (file.size || 0) / 5000,
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="fa fa-folder-open"></i></i>&nbsp;',
        browseClass: 'btn btn-brown',
        removeIcon: '<i class="fa fa-trash"></i>',
