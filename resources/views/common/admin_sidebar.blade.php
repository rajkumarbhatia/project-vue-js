<div class="sidebar" data-color="red" data-image="{{ url('public/admin/assets/img/sidebar-5.jpg') }}">
            <!--
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <img style="height: 50px;margin-left: 32px;" src="{{ url('public/imgs/logo.png') }}">
                </div>
                <div class="user">
                    <div class="photo">
                        <img src="{{ url('public/admin/assets/img/default-avatar.png') }}" />
                    </div>
                    <div class="info ">
                ...
                <ul class="nav">
                    <li class="nav-item " id="dashboard-side">
